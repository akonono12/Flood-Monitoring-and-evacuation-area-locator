  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>LDRRMC Dashboard</b></a>
            <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <h5 class="centered">Fullname:</h5>
                  ...
                  <li class="mt">
                      <a class="active" href="SafeTips.php">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Safety Tips</h3>
            <div class="row mt">
                <div class="col-lg-12">
        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form flex-sb flex-w" method="POST" action="AddTipsScript.php">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Message is required">
                    <textarea class="input100" name="message" placeholder="Write a tips"></textarea>
                    <span class="focus-input100"></span>
                </div>
      ...
      <footer class="site-footer">
          <div class="text-center">
              --------------  LDRRMC  --------------
              <a href="SafeTips.html#" class="go-top">
